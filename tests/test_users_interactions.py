from src.users_interactions import filter_vacancies, get_vacancies_by_salary


def test_filter_vacancies_no_matches():
    vacancies_list = [
        {"name": "Vacancy A", "snippet": "Some description.", "salary": {"from": 100000, "to": 150000}},
        {"name": "Vacancy B", "snippet": "Another description.", "salary": {"from": 50000, "to": 70000}},
    ]
    filter_words = ["Ruby"]
