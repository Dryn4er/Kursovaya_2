...
def get_vacancies_by_salary(filtered_vacancies, salary_range):
    ...
    return sorted(filtered_salary_vacancies, key=lambda x: x["salary"].get("to", 0), reverse=True)
...
if __name__ == "__main__":
    my_list = [
        {"name": "Август", "snippet": "Август и февраль", "salary": {"from": 100, "to": 200}},
        {"name": "Сентябрь", "snippet": "Август и февраль", "salary": {"from": 100, "to": 300}},
        {"name": "Октябрь", "snippet": "ноябрь", "salary": {"from": 400, "to": 500}},
        {"name": "Ноябрь", "snippet": "февраль", "salary": {"from": 600, "to": 800}},
    ]
